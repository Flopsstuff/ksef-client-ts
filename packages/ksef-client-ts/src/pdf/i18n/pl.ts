...
export const pl: LabelBundle = {
  ...
  paidTotal: 'Zapłacono razem',
  overpaid: 'Nadpłata do rozliczenia',
  ...
  advancePayments: 'Otrzymane płatności',
  advancePaymentAmount: 'Kwota płatności',
  advancePaymentDate: 'Data otrzymania',
