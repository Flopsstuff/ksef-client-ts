export {
  ...
  CertificateFingerprint, CertificateSerialNumber, Base64String, Ip4Address, Ip4Range, Ip4Mask, Sha256Base64,
  ...
  isValidCertificateFingerprint, isValidCertificateSerialNumber, isValidBase64, isValidIp4Address, isValidSha256Base64,
} from './patterns.js';
export {
