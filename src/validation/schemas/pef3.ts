...
const InvoiceType = z.object({
  ...
  "InvoiceTypeCode": z.any().optional(),
  ...
  "ProjectReference": z.preprocess(v => Array.isArray(v) ? v : v == null ? [] : [v], z.array(z.any()).min(0)).optional(),
  ...
  "PrepaidPayment": z.preprocess(v => Array.isArray(v) ? v : v == null ? [] : [v], z.array(z.any()).min(0)).optional(),
...
export type PEF3 = z.infer<typeof PEF3Schema>;
